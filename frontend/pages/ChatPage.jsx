...
import SearchUsers from '../components/friends/SearchUsers'; // Komponent wyszukiwania użytkowników
      ...
      <Container>
        <Grid container spacing={3}>
          <Grid item xs={12} md={4}>
            ...
            <Button onClick={() => setSelectedTab('search')}>Search Users</Button> {/* Przycisk do przejścia do wyszukiwania użytkowników */}
          </Grid>
          <Grid item xs={12} md={8}>
            ...
            {selectedTab === 'search' && <SearchUsers />} {/* Wyświetla komponent wyszukiwania */}
          </Grid>
        </Grid>
      </Container>
    );
